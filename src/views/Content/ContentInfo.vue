<template>
  <div class="content-info">右内容
      ...
      <element-table :tableData="tableData">
           ...
           <el-table-column show-overflow-tooltip label="名字" prop="name" width="300"></el-table-column>
           <el-table-column show-overflow-tooltip label="URL" prop="url" ></el-table-column>
           <el-table-column show-overflow-tooltip label="Image" prop="image"></el-table-column>
           <!-- 删除 -->
